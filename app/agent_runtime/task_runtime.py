"""Core orchestration runtime for the reusable agent runtime package.
...
from app.agent_runtime.models import RunnerResult, TaskSnapshot, TaskSubmission
...
from app.agent_runtime.workspace import TaskWorkspace, WorkspaceManager
