"""Agent runtime-local storage protocol.

Host applications can satisfy this protocol with their own persistence layer
without importing the agent runtime from an app-specific store module.
"""
...
from app.agent_runtime.state import ApprovalAction, Run, Task, TaskEvent
