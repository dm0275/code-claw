"""Runner implementations for the agent runtime package.
...
from app.agent_runtime.models import RunnerResult
from app.agent_runtime.protocols import EventBrokerProtocol
